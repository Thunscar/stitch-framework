...
INSERT INTO sys_menu (menu_id, menu_name, parent_id, order_num, path, component, query, is_frame, is_cache, menu_type, visible, status, perms, icon, is_delete, create_user, create_time, update_user, update_time, remark) VALUES (136, '账号解锁', 106, 8, '', '', '', null, null, 'B', null, '0', 'sys:user:resetPassword', '', '0', 'stitch', SYSDATE(), 'stitch',SYSDATE(), '账号解锁按钮');
INSERT INTO sys_menu (menu_id, menu_name, parent_id, order_num, path, component, query, is_frame, is_cache, menu_type, visible, status, perms, icon, is_delete, create_user, create_time, update_user, update_time, remark) VALUES (137, '分配角色', 106, 8, '', '', '', null, null, 'B', null, '0', 'sys:user:allocatedRole', '', '0', 'stitch', SYSDATE(), 'stitch',SYSDATE(), '分配角色按钮');
